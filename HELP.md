...
* The original package name 'com.project.spring-kafka-consumer' is invalid and this project uses 'com.project.spring_kafka_consumer' instead.
...
```
$ docker run --rm spring-kafka-consumer:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/spring-kafka-consumer
```
